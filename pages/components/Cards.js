            ...
            <div className="grid grid-rows-1 gap-4 lg:gap-6">
                {data.map((p) => {
                    ...
                    >
                        ...
                        <p className="text-base font-semibold lg:text-lg">{p.nameOfTheCourse}</p>
                        </span>
                        <p className="text-sm lg:text-base">{p.collegeName}</p>
                        <p className="text-sm lg:text-base">{p.url}</p>
                    </div>
                    );
                })}
                </div>
